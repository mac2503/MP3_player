...
def play_song():
    ...
    try:
        ...
        mixer.music.play()
        song_title_label.config(fg="green", text="Playing: "+str(song_title))
...
Label(master, text="Please select the music track that you would like to play!", font=("Calibri", 12), fg="blue").grid(sticky="N", row=1)
